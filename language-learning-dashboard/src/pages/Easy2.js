...
import "../styles/easy2-styles.css";
  ...
  const fetchQuestions = async () => {
    try {
      ...
      const response = await fetch(
        "http://10.16.49.225:5000/api/generate/words"
      );
        ...
        <div className="results-details">
          ...
          <div className="results-grid">
            {results.map((result, index) => (
              ...
              >
                <div className="result-word">{result.target}</div>
                ...
                <div className="result-detected">
                  Detected: {result.extracted_text || "None"}
                </div>
              </div>
            ))}
          </div>
    ...
    <div className="practice-container">
      ...
      <div className="question-card">
        <div className="question-prompt">
          <h2>Write the following word:</h2>
          <div className="word-display">{currentQuestion?.content}</div>
        </div>
            ...
            {activeTab === "draw" ? (
              <div className="drawing-container">
                <DrawingCanvas
                  ...
                  canvasHeight={300}
                />
                <p className="hint-text">Draw the word in the box above</p>
              </div>
            ) : (
